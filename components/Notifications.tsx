...
const Notifications = () => {
    ...
    const unreadNotifications = inboxNotifications.filter((notificaiton) => !notificaiton.readAt);
    ...
    return (
        <Popover>
            ...
            justify-center rounded-lg'>
                ...
                />
                { count && (
                        <div className='absolute right-0 top-0 z-20 size-2 rounded-full bg-blue-500'>
                        </div>
                    )
                }   
            </PopoverTrigger>
                ...
                >
                    <InboxNotificationList>
                        {unreadNotifications.length <= 0 && (
                            <p className='text-center text-dark-500 py-2'>No new notifications</p>
                        )
                        }
                        {unreadNotifications.length > 0 && (
